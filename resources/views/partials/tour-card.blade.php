    ...
    <div class="relative bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 h-full flex flex-col">
        ...
        <div class="relative h-72 overflow-hidden">
            ...
            <div class="absolute top-4 left-4 z-10">
                <div class="flex items-center gap-1.5 px-3 py-1.5 bg-white/95 backdrop-blur-sm rounded-lg shadow-md">
                    <svg class="w-4 h-4 text-orange-500" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clip-rule="evenodd"/>
                    </svg>
                    <span class="text-sm font-bold text-gray-700">{{ $distance }}</span>
                </div>
            </div>
        ...
        <div class="p-5 flex-1 flex flex-col">
            ...
            <div class="mb-5 flex-1">
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex items-start gap-2.5">
                        ...
                        <span class="text-sm text-gray-600 leading-tight">{{ $highlight }}</span>
                    </div>
                    @endforeach
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4 py-4 border-t border-gray-100">
                <div class="text-center">
                    <div class="text-2xl font-bold text-gray-800">{{ $distance }}</div>
